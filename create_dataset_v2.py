...
to match the final spatial size. This image is saved as the anisotropic version
of the data. The same image is also resampled to an isotropic resolution using
