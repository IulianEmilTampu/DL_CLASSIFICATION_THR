...
test_dataset = utilities.TFR_3D_sparse_dataset(test_img,
                    dataset_type = 'test',
                    batch_size=10,
                    buffer_size=10,
...
acc = utilities.plotConfusionMatrix(test_summary['labels'], ensemble_pred_argmax, classes=config['label_description'], savePath=model_path, draw=False)

# ############ plot and save ROC curve
fpr, tpr, roc_auc = utilities.plotROC(test_summary['labels'], ensemble_pred_logits, classes=config['label_description'], savePath=model_path, draw=False)
...
# ############ plot and save ROC curve
precision, recall, average_precision, F1 = utilities.plotPR(test_summary['labels'], ensemble_pred_logits, classes=config['label_description'], savePath=model_path, draw=False)
# make elements of the dictionary to be lists for saving
...
# save summary file
with open(os.path.join(model_path,'test_summary.txt'), 'w') as fp:
